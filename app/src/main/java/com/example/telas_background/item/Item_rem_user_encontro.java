...
public class Item_rem_user_encontro extends Item<ViewHolder> implements View.OnClickListener {

    public final Classe_user_tela user;
    private Integer positionRequest;
    private Item item;

    public Item_rem_user_encontro(Classe_user_tela user) {
        this.user = user;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.socializar_add_user_encontro:
                DialogEncontroAddRemove.botaoItemRecyclerEncontroAdd(item, 1 , positionRequest);
    ...
    public int getLayout() {
        ...
        return R.layout.item_rem_user_encontro;
    }
