...
public class Friend_request_firebase {
    ...
    public static void denyRequest(String user2){

        FirebaseFirestore db = FirebaseFirestore.getInstance();
        DocumentReference documentReference = db.collection("request").document(User_principal.getId())
                .collection("request").document(user2);
    ...
    public static Task<String> sendFriendRequest(String user2) {
    ...
    public static Task<String> removeFriend(String user2){
        Log.d("send", "entrou");
